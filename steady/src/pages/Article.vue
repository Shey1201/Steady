...
<template>
  <div v-if="article" class="min-h-screen bg-white pb-24">
    <!-- Header Bar -->
            ...
            <div class="space-y-6">
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-xs font-bold text-slate-500 uppercase tracking-wider">Font Size</span>
              ...
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-xs font-bold text-slate-500 uppercase tracking-wider">Line Height</span>
              ...
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-xs font-bold text-slate-500 uppercase tracking-wider">Paragraph Gap</span>
              ...
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-xs font-bold text-slate-500 uppercase tracking-wider">Max Width</span>
  ...
  <div v-else class="flex flex-col items-center justify-center h-screen bg-slate-50">
    <div class="text-slate-400 mb-4 text-lg">Article not found</div>
    <button @click="router.push('/reading')" class="text-blue-600 font-bold hover:underline">Go back to Library</button>
  </div>
</template>
